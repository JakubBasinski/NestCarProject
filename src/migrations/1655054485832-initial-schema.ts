...
export class initialSchema1655054485832 implements MigrationInterface {
    name = 'initialSchema1655054485832'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_report"("id", "approved", "aaaaa", "make", "model", "year", "lng", "lat", "mileage", "userId") SELECT "id", "approved", "price", "make", "model", "year", "lng", "lat", "mileage", "userId" FROM "report"`);
